...
export const THEME_PRESETS: readonly ThemePreset[] = [
  {
    value: "default",
    light: {
      background: "#f6f8fb", surface: "#ffffff", surfaceMuted: "#f3f5f9",
      text: "#1b2348", textMuted: "#637089",
      accentSoft: "#fff1e7", accentStrong: "#cc4b00", accentHover: "#bf4800",
      accentContrast: "#ffffff", accentText: "#bd4600", accentTextStrong: "#a63d00",
      frame: "#e6ebf2",
    },
    dark: {
      background: "#101522", surface: "#171e30", surfaceMuted: "#202940",
      text: "#edf1fb", textMuted: "#abb7ce",
      accentSoft: "#382719", accentStrong: "#ff8a3d", accentHover: "#ffa366",
      accentContrast: "#171e30", accentText: "#ffac70", accentTextStrong: "#ffc49a",
      frame: "#303b53",
    },
  },
  {
